...
urlpatterns = [
    ...
    path('update-pivot-plot/', views.UpdatePivotPlot.as_view(), name='update_pivot_plot'),
    ...
    path('update-pivot-plot-order/', views.UpdatePivotPlotOrder.as_view(), name='update_pivot_plot_order'),
    ...
    path('remove-project-share/', views.RemoveProjectShare.as_view(), name='remove_project_share'),
    path('get-shared-projects/', views.GetSharedProjects.as_view(), name='get_shared_projects'),
