...
const CustomScriptModal = ({ isOpen, onClose, sheetData, setSheetData }) => {
  ...
  const executeScript = async (action) => {
    ...
    setError(null);
    try {
      const response = await fetch(" https://sanitifi.skewb.ai:8000/api//custom-script/", {
        method: "POST",
        headers: {
  ...
  const fetchSavedScripts = useCallback(async () => {
    ...
    try {
      ...
      const response = await fetch(" https://sanitifi.skewb.ai:8000/api//fetch_scripts/", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
  ...
  const handleSaveScript = async (scriptData) => {
    ...
    try {
      ...
      const response = await fetch(" http://localhost:8000/api//save_script/", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
